...
myfunction:
       ...
       mov %r8 ,         %rax
       and $0x0f0f0f0f , %rax           # get pocket ranks in AX 
       mov %eax,     -32(%rsp)          # save pocket ranks and 1st, 2nd flop in "red zone"
       mov %r8 ,         %rax
       shr $32, %rax
       and $0x0f0f0f0f , %rax           # get flop ranks in EBX
       mov %eax,     -64(%rsp)          # save 3rd flop, turn, river (+ empty) ranks in "red zone"
